...
async def lifespan(_: FastAPI) -> AsyncIterator[None]:
    ...
    # Fail fast: if Redis isn't reachable, refuse to boot. Better than accepting
    # traffic and 500-ing on the first /auth/register call.
    await ping_redis()
    # Warn-and-continue: S3 is off the hot path for almost every route.
    # ping_s3() never raises — see app.storage.s3 docstring for the rationale.
